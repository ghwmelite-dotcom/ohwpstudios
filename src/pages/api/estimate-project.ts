          ...
          await sendEmail(runtime?.env ?? {}, {
            ...
            html: emailShell(
              ...
              `<p>Hi ${firstName},</p>
               ...
               <p style="text-align:center;font-size:13px;">Ready to move? <a href="https://ohwpstudios.org/booking?utm_source=proposal_email" style="color:#E3A92B;">Book a free consult</a>.</p>`,
            ),
          });
        } catch (e) {
